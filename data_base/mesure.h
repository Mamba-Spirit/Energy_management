...
private:
    ...
    float puissance;
    string date_mesure;
    //std::chrono::system_clock::time_point date_mesure;
...
public:
    ...
    //std::chrono::system_clock::time_point get_date_mesure() const;
    ...
    //void set_date_mesure(string date_mesure);
    //void set_date_mesure(const std::chrono::system_clock::time_point& date_mesure);

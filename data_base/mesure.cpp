...
//std::chrono::system_clock::time_point MESURE::get_date_mesure() const {return date_mesure;}
...
//void MESURE::set_date_mesure(const std::chrono::system_clock::time_point& date_mesure) {
